  ...
  function() {
    ...
    function() {
      (0, e.amdDefine)("52", ["a", "1e", "15", "5", "6", "43", "53", "d", "4f"], function(e, t, n, i, r, o, s, a, u) {
        ...
        function c(e) {
          e = n(e, {}), this._ellipsoid = n(e.ellipsoid, o.WGS84), this._rectangle = n(e.rectangle, u.MAX_VALUE), this._projection = new s(this._ellipsoid), this._numberOfLevelZeroTilesX = n(e.numberOfLevelZeroTilesX, 2), this._numberOfLevelZeroTilesY = n(e.numberOfLevelZeroTilesY, 1)
        }
        return r(c.prototype, {
          ellipsoid: {
            get: function() {
    ...
    function() {
      (0, e.amdDefine)("3d", ["15", "5", "7a"], function(e, t, n) {
        ...
        var E, m, w, N, D, T, I, O, S, _, L, j, x, b, C, R, z, P = {
          ...
          firefoxVersion: y,
          isWindows: g,
          hardwareConcurrency: e((E = "undefined" != typeof navigator ? navigator : {}).hardwareConcurrency, 3),
      ...
      return {
        ...
        execute: function() {
          ...
          Qt = function(e) {
            ...
            function(e) {
              function t(e, t) {
                return e ? (t = t || {}, t.p = se.clone(e.p, t.p), t.o = Re.clone(e.o, t.o), t.r = e.r, t.meta = e.meta, t) : null
              }
              e.clone = t
            }(nn || e("SerializedEntityState", nn = {})),
            function(e) {
              function t(e, t) {
                return t = t || {}, t.type = e.type, t.projectionMatrix = _e.clone(e.projectionMatrix, t.projectionMatrix), t.viewport = $t.clone(e.viewport, t.viewport), t
              }
            ...
            }, Bn = Object.freeze({}), e("SessionPort", Fn = function() {
              function e(t) {
                var n = this;
            ...
            function(e) {
              ...
              return Object.defineProperty(e.prototype, "viewportMode", {
                ...
                for (var s = 0, a = 0, u = r; a < u.length; a++) {
                  var c = u[a],
                    l = o[s] = o[s] || {};
                  l.index = s, l.type = c.type, l.viewport = l.viewport || {}, l.viewport.x = c.viewport.x, l.viewport.y = c.viewport.y, l.viewport.width = c.viewport.width, l.viewport.height = c.viewport.height, l.renderViewport = l.renderViewport || {}, l.renderViewport.x = c.viewport.x * n, l.renderViewport.y = c.viewport.y * i, l.renderViewport.width = c.viewport.width * n, l.renderViewport.height = c.viewport.height * i, l.frustum = this._subviewFrustum[s] = this._subviewFrustum[s] || new je, Y(c.projectionMatrix, l.frustum), l.projectionMatrix = l.frustum.projectionMatrix, l.pose = t.getEntityPose(t.getSubviewEntity(s)), s++
                }
              ...
              function e(e, t, n) {
                ...
                this.frameStateEvent.removeEventListener = function(e) {
                  ...
                  "ar.origin" !== e.id && "ar.stage" !== e.id || (i.suggestedGeolocationSubscription = e.options || {}, i.suggestedGeolocationSubscriptionChangeEvent.raiseEvent(void 0))
                ...
                if ("undefined" != typeof window && window.addEventListener && !ge(this._deviceOrientationListener)) {
                  ...
                  this._deviceOrientationListener = function(n) {
                    ...
                    if (ge(i) && (n.absolute && (t = 0), e._deviceOrientationHeadingAccuracy = o > 0 ? o : void 0, (!ge(t) || Math.abs(0) > 5) && ge(r) && o >= 0 && o < 80 && r >= 0 && (ge(t) ? t -= 0 : t = -r), ge(t) && ge(n.alpha) && ge(n.beta) && ge(n.gamma))) {
                      ...
                      e.deviceOrientation.orientation.setValue(p), e.deviceOrientation.meta = e.deviceOrientation.meta || {}, e.deviceOrientation.meta.geoHeadingAccuracy = o || void 0
                    }
                        ...
                        if (n._presentingRealityViewer === r) {
                          if (0 === i.version[0]) {
                            ...
                            var o = e.eye,
                              s = o.pose,
                              a = o.fov;
                            e.entities = e.entities || {}, e.entities["ar.user"] = s;
            ...
            function(e) {
              ...
              ARController.getUserMedia = function(e) {
                ...
                var i = new THREE.OrthographicCamera(-.5, .5, -.5, .5, -.5, .5),
                  r = new THREE.Scene;
                r.add(n), r.add(i), "portrait" === this.orientation && (n.rotation.z = Math.PI / 2);
